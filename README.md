...
- [x] Code optimization (v1.2.0) and publish the protocol for the prognosis module (Under Review)
...
| 2.3   data(Immune3_COX_MP_SKCM06)                          | `TimiCOX` results with the above annotation that reveals the association between each marker pair and favorable prognosis.   |
| 3.1   data(`CellType_Tirosh2016_melanoma_TME`)             | Metastatic melanoma tumor microenvironment cell types and markers |
| 3.2   data(TME_COX_MP_SKCM06)                              | `TimiCOX` results with the above annotation that reveals the association between each marker pair and favorable prognosis.   |
| 4.1   data(`CellType_Zheng2021_Tcell`)                     | T cell subtypes and markers                                       |
| 4.2   data(Tcell_COX_MP_SKCM06)                            | `TimiCOX` results with the above annotation that reveals the association between each marker pair and favorable prognosis.   |
...
| 6.2   data(Newman2015_COX_MP_SKCM06)                      | `TimiCOX` results with the above annotation that reveals the association between each marker pair and favorable prognosis.   |
## Example
