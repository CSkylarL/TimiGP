#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
# This is an example how to use TimiGP with Hughes2020_Tirosh2016 melanoma_TME annotation
# Date: 03/07/2022
# Chenyang Li
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
library(TimiGP)
...
data("CellType_Hughes2020_Tirosh2016_melanoma_TME")
geneset <- CellType_Hughes2020_Tirosh2016_melanoma_TME
...
#save(TME_COX_MP_SKCM06, file = "data/melanoma_TME_COX_MP_SKCM06.rda")
...
NET <- TimiGeneNetwork(resdata = cox_res,dataset = "Hughes2020_Tirosh2016",export =TRUE, path = "./notebook/manuscript/Hughes2020_Tirosh2016_melanoma_TME/")
...
geneset$Dataset <- "Hughes2020_Tirosh2016"
...
# You can use Cytoscape to visualize the network
NET <- TimiCellNetwork(resdata = res,dataset = "Hughes2020_Tirosh2016",export =TRUE, 
                       path = "./notebook/manuscript/Hughes2020_Tirosh2016_melanoma_TME/")
...
# Cell Chord Diagram
TimiCellChord(resdata = res,dataset = "Hughes2020_Tirosh2016")
