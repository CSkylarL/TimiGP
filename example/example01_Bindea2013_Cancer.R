...
NET <- TimiGeneNetwork(resdata = cox_res,dataset = "Bindea2013_Cancer",export =TRUE, path = "./notebook/manuscript/Bindea2013_Cancer/")
...
NET <- TimiCellNetwork(resdata = res,dataset = "Bindea2013_Cancer",export =TRUE, path = "./notebook/manuscript/Bindea2013_Cancer/")
head(NET$network,n = 3)
head(NET$node,n = 3)
head(NET$edge,n = 3)
